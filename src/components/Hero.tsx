...
<img
                    src="/Aishwarya-Rajguru_Profile.png"
                    alt="Aishwarya Rajguru"
                    className="w-full h-full object-cover"
                  />
              </div>
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            <span className="block text-white">Aishwarya</span>
          ...
          <p className="text-lg text-gray-400 mb-12 max-w-2xl mx-auto leading-relaxed">
            ...
            working with large and diverse datasets to generate meaningful insights. Experienced with cloud platforms.
          </p>

          {/* Contact Info */}
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 mb-12 text-gray-300">
            <div className="flex items-center gap-2">
              <span>📧 aishwarya.rajguru007@gmail.com</span>
            </div>
            <div className="flex items-center gap-2">
              <span>📱 +353 899784568</span>
            </div>
            <div className="flex items-center gap-2">
